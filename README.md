...
- A **Google Sheet** to act as the ticketing database. You can create a new one or use our [provided template](https://docs.google.com/spreadsheets/1ZmXAURXe6KZyaIaFbbFxQaARn8-Weyg11CoTDvUJDj0/copy).

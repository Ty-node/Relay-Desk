...
- A **Google Sheet** to act as the ticketing database. You can create a new one or use our [provided template](https://docs.google.com/spreadsheets/d/1a2b3c4d5e/copy).
